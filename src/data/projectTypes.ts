...
const ECOMMERCE_FIELDS: (IntakeFieldDefinition & { stageId: string })[] = [
  ...
  { stageId: "security", name: "ecommerceDecisions", label: "Ecommerce decision register", description: "One record per line with exactly six fields: ID | architecture, launch or optional | Needs answer, Deferred, Answered or Not applicable | question | reason | approved answer. Inside a field, write \\| for a literal pipe and \\\\ for a literal backslash. Existing OQ records in Assumptions are imported as unresolved until explicitly resolved here.", placeholder: "OQ-01 | launch | Deferred | Free-shipping threshold? | Needed before launch |", multiline: true },

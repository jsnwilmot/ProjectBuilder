...
export const intakeSteps: IntakeStep[] = [
  {
    ...
    fields: [
      ...
      { name: "clientName", label: "Client name", description: "The person accountable for the project.", placeholder: "Client or sponsor name" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "userRoles", label: "User roles", description: "List roles and their main responsibilities.", placeholder: "Role — responsibilities", multiline: true },
      { name: "permissions", label: "Permissions", description: "State who can view, create, edit, approve, or delete.", placeholder: "Role — allowed actions", multiline: true }
    ]
  },
  {
    id: "features",
    ...
    fields: [
      ...
      { name: "screens", label: "Screens", description: "List the expected pages, views, or panels.", placeholder: "Screen — purpose", multiline: true },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "dataCollections", label: "Tables, lists, or collections", description: "Name the records the app must store or manage.", placeholder: "Collection — purpose", multiline: true },
      { name: "fields", label: "Fields", description: "List important fields for each collection.", placeholder: "Collection.field — type — rules", multiline: true },
  ...
  },
  {
    ...
    fields: [
      { name: "workflows", label: "Workflows", description: "List each workflow from trigger to outcome.", placeholder: "Trigger → steps → outcome", multiline: true },

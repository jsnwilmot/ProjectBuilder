...
describe("Planning readiness mapping contract", () => {
  ...
  it.each([
    ...
    ["canonicalDestinationPaths", ["powerPlatform.canvas.nonexistentField"], "invalidCanonicalPath"],
    ["canonicalMergePaths", ["powerPlatform.common.nonexistentField"], "invalidCanonicalPath"],
    ["canonicalValidatorDependencyPaths", ["powerPlatform.canvas.nonexistentDependency"], "invalidCanonicalPath"],
    ["canonicalValidatorDependencyPaths", ["project.powerPlatform.canvas.sharePointSites"], "invalidCanonicalPath"],
